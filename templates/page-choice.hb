<div data-role="page" id="{page_id}" data-backbtn="false" data-theme="c" class="choice-question">
   ...
   <div data-role="footer" data-position="fixed" class="footer">
      <a href="#intro" data-icon="arrow-l" data-iconpos="left" data-direction="reverse">Back to Start</a>
      {#previous}<a href="#{.}" data-icon="arrow-l" data-iconpos="left" data-direction="reverse" class="previous-button">Previous</a>{/previous}
      {#next}<a href="#{.}" data-icon="arrow-r" data-iconpos="right" class="next-button">Next</a>{/next}
